...
if __name__ == "__main__":
    ...
    for number_of_connections_watts in range(5, 16):
        ...
        with open(f"/home/vladyslav/VSCodeProjects/briolette/src/simulation/briolettesim/graphs/watts-strogatz-{number_of_connections_watts}-connections.txt", "w") as file:
            for edge in G.edges():
