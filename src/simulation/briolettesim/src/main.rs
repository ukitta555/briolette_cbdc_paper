...
fn create_experiment_directory(experiment_type: &str, population_size: u64) -> io::Result<String> {
    let base_dir = match experiment_type {
        "predefined" => "results/predefined_experiments",
        "sobol" => "results/sobol_experiments",
        ...
        Commands::Predefined => {
            ...
            let predefined_experiments = vec![
                ExperimentConfig { // 1:1
                    ...
                    merchants: 30, 
                    banks: 10,
                    graph_file: String::from("graphs/barabasi_albert_8_m.txt"),
                    p2m_probability: 0.2, 
                    p2p_probability: 0.6, 
                ...
                ExperimentConfig { // 1:1
                    ...
                    merchants: 30, 
                    banks: 5,
                    graph_file: String::from("graphs/watts-strogatz-5-connections.txt"),
                    p2m_probability: 0.2, 
                    p2p_probability: 0.6, 
                    move_probability: 0.2,  
                    random_sync_probability: 0.01,  
                        ...
                        experiments
                            ...
                            .push(
                                ExperimentConfig {
                                    ...
                                    merchant_sync_frequency: 16, // original value 8
                                    tickets_given_right_away: 16, //original value 8 
